import datetime
import os
AWS_ACCESS_KEY_ID = os.environ.get('AWS_ACCESS_KEY_ID', 'AKIAJAZAUZ3ATB466Z5A') #"AKIAIWPRIUTTARYHLUUA"
AWS_SECRET_ACCESS_KEY = os.environ.get('AWS_SECRET_ACCESS_KEY', '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') #"NJbxy1areLLTtuynZNiP7m8ZHZD95ftTdMlod5v6"
AWS_STORAGE_BUCKET_NAME = 'ollydorvelus'
...
DEFAULT_FILE_STORAGE = 'ollydorvelus.aws.utils.MediaRootS3BotoStorage'

STATICFILES_LOCATION = 'static'
STATICFILES_STORAGE = 'ollydorvelus.aws.utils.StaticRootS3BotoStorage' #'vidcraft.aws.custom_storages.StaticStorage'
